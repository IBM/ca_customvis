...
`loadGoogleChart()` attaches google loader from `https://www.gstatic.com/charts/loader.js`. It returns a promise that resolves as soon as google loader script finishes and `google` global is available.
